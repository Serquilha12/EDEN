...
public class MenuScreen implements Screen {
    ...
    public void show() {
        ...
        btnPlay.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                game.setScreen(new GameScreen(game)); // ✅ passa game como argumento
            }
        });
    ...
    private TextureRegionDrawable createButtonBackground(Color color) {
        ...
        pixmap.dispose();
        // Guarda referência à textura mais recente para dispose (up é a última criada)
        if (btnUpTexture == null) btnUpTexture = texture;
        else btnDownTexture = texture;
